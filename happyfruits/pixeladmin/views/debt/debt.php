    <div id="content-wrapper">
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-warning"></i> ID bản lưu công nợ không đúng!!</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-edit"></i> <?=!$id?'Thêm':'Sửa thông tin'?> bản lưu công nợ</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-6 col-md-6">
                    <form id="frmMain" data-toggle="validator" class="one-line" role="form" method="post" action="<?=BASE_URL?>xu-ly">
	                    ...
	                    <div class="form-group">
		                    ...
		                    <?php echo html_select_debt_status('name="status" class="form-control" id="status"', null, getvalue($obj, 'status'));?>
		                    <div class="help-block with-errors"></div>
	                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?=BASE_URL. $URIs['debts']?>" class="btn btn-info"><i class="fa fa-reply"></i> Quay lại danh sách</a>
