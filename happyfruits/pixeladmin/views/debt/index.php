            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="list_container" class="table-responsive">
                        <?php $controlerObj->load_view("debt/list");?>
                    </div>
                    <div class="for_datatable_filter">
                        <ul>
                            ...
                            <li>Ngày thanh toán từ:
                                <input class="form-control" style="width: 120px;" size="16" id="filter_start_date" type="text" data-date-format="dd/mm/yyyy" value="01/07/2018" readonly=""/>
                            </li>
                            <li>Đến:
                            ...
                            <li>
	                            ...
	                            <a href="<?=BASE_URL. $URIs['debts'] . '/them'?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm</a>
                            </li>
	                        <?php if (Users::can('view_summary', 'debt')):?>
			    ...
			    <div class="modal-content" style="text-align: center;">
				    ...
				    <div class="modal-body">
					    <form name="frmPayment" id="frmPayment" method="post" action="" class="one-line">
						    ...
						    <input type="hidden" value="admin_update_cost_from_debt" name="action" />
