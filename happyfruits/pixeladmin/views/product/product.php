                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                <div class="box_item_info"><?= getvalue($item, 'name') ?></div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group">
                                                            ...
                                                            <td class="center">
                                                                <div class="box_item_price"><?= number_format(getvalue($item, 'sell_price', 0) * 1000, 0, '.', '.') ?></div>
                                                            </td>
                                                            <td class="center">
                                                                <div class="box_item_total"><?= number_format(getvalue($item, 'amount', 0) * getvalue($item, 'sell_price', 0) * 1000, 0,  '.', '.') ?></div>
                                                            </td>
                                                            <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <div class="box_item_price"></div>
                                                    </td>
                                                    <td class="center">
                                                        <div class="box_item_total"></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <div class="box_discount_amount"></div>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                <div class="item_info"><?= getvalue($item, 'name') ?></div>
                                                            </td>
                                                            <td class="center">
                                                                <div class="item_cat"><?= !empty($item['type_name']) ? $item['type_name'] : '' ?></div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group">
