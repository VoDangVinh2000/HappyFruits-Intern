 ...
 *
 * -------------------------------------------------------
 * Classname:        BaseInventoryexportdetails
 ...
 * Class declaration
 */
class BaseInventoryexportdetails extends eModel
{
    /**
     * Attribute declaration
     */
    var $id;  /* Primary key */
    var $export_id;    /* int(11) */
    var $item_id;    /* int(11) */
    var $quantity;    /* int(6) */
    ...
    {
        parent::__construct();
        $this->table_name = 'inventory_export_details';
        $this->primary_key = 'id';
    }
