...
if(need_update)
$scope.getTotals();};$scope.validateQuantity=function(key){if($scope.orderedItems[key].quantity==''||parseInt($scope.orderedItems[key].quantity)<=0)
$scope.orderedItems[key].quantity=1;$scope.getTotals();};$scope.onChangeQuantity=function(key){if($scope.orderedItems[key].quantity!=''&&parseInt($scope.orderedItems[key].quantity)>0)
