                    ...
                    <form action="/register" method="post">
                        <div class="main-create-account-fillout">
                            ...
                            <div class="password-wrapper">
                                ...
                                <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).{5,}" title="Password must have limited one number, one uppercase letter, one lowercase letter and minimum length is 8" autocomplete="on" id="password" type="password" name="password_en" class="input-account" autocapitalize="words" placeholder="Password" required>
                                <i class="fas fa-eye" id="btnShowPass"></i>
                            </div>
                            <p class="efruit-en suggest-message">Password must have one number and at least 5 characters</p>
                            <p class="efruit-vi suggest-message">Mật khẩu phải có một sốvaf tối thiểu 5 kí tự</p>
