                    ...
                    <div class="container">
                        <div class="cart-total">
                            ...
                            <div class="cart-dir mt-5">
                                ...
                                <a class="col-sm-6 text-right-sm mybtn btn-payment  efruit-en" href="/vi">Continue Shopping</a>
                            </div>
                            ...
                            <div class="row address" style="display: flex;justify-content: space-between;">
                                ...
                                <div class="col-md-5">
                                    <div class="block-add-address">
                                        <?php if (env('NEED_BOOKER_DETAILS')) : ?>
                                            <div class="col-sm-12 col-md-10">
                                                <div class="form_errors fw-bold fs-5" ng-hide="validateShipping()">
                        ...
                        <div class="col-lg-12 col-md-12 no-padding">
                            <div class="col-sm-12">
                                ...
                                <div class="row mt10" style="align-items: center;">
                                    <div class="col-md-3 fs-6 fw-bold">
                                        <span bind-translate="Tổng cộng">Tổng cộng</span> <span>{{ totalQuantity }}</span> <span bind-translate="phần">phần</span>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row mt10" style="align-items: center;" ng-if="discount_amount">
                                    ...
                                    <div class="col-md-5">
                                        <p>-{{discount_amount*1000|efruit_money}}<sup>đ</sup></p>
                                    </div>
                                </div>
                                <div class="row mt10" style="align-items: center;" ng-if="has_VAT">
                                ...
                                <div class="promotion_section row mt10">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="promotion_code_input" placeholder="{{__('Nhập mã khuyến mãi')}}" ng-model="promotion_code" />&nbsp;
                                        <a class="btn fw-bold fs-6" tabindex="-1" href="" bind-translate="Áp dụng" ng-click="checkPromotionCode($event)">Áp dụng</a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt10">
                                    <div class="col-md-3 fw-bold fs-5 text-dark-gray">
                                        <span bind-translate="Tổng cộng">Tổng cộng</span>
                                    </div>
                                    <div class="col-md-5">
                                        {{(subtotal-discount_amount+shipping_fee + VAT*(subtotal-discount_amount))*1000|efruit_money}}<sup>đ</sup>
                                    </div>
                                </div>
                                <div class="row mt10">
                                    <div class="col-md-5">
