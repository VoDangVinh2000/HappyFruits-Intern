               ...
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="input-group input-group-lg">
                           ...
                           aria-describedby="button-addon2" auto ng-model="search" name="key" 
                           class="form-control" placeholder="Search...">
                           <button name="submit" value="submit" class="btn btn-outline-secondary" type="submit" id="button-addon2" style="padding: 1.5em 1.8em; border-radius: 0; background: #333; border: none;">
