       ...
       <nav class="navbar navbar-expand-lg navbar-light logo-nav scroll-nav-mobile">
           ...
           <div class="container ">
               <ul class="navbar-nav ms-auto right-main-nav sub-cart">
                   <li class="nav-item efruit-cart" style="border: unset;">
                       <a class="" data-toggle="modal" data-target="#exampleModal" id="show-cart" href="#">
               ...
               <div class="collapse navbar-collapse">
                   <ul class="navbar-nav ms-auto right-main-nav">
                       ...
                       <?php } ?>
                       <div class="nav-item main-cart-btn efruit-cart" style="border: unset;">
                           <a class="" data-toggle="modal" data-target="#exampleModal" id="show-cart" href="#">
