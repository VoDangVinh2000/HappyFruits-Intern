                        <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-exportlist">
                            ...
                            <tbody>
                                ...
                                <tr id="<?=$item['id']?>">
                                    ...
                                    <td class="center"><?=date('d/m/Y H:i:s', strtotime($item['export_date']))?></td>
                                    ...
                                    <td class="center not_filter">
                                        <a href="<?=BASE_URL. $URIs['inventory_check']?>/<?=$item['id']?>" class="btn btn-sm btn-warning" title="Xem chi tiết"><i class="fa fa-navicon"></i> Chi tiết</a>
                                    </td>
                                </tr>
                                    <?php endforeach;?>
                                <?php endif;?>
