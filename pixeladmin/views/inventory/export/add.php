    ...
    inventory_items.push(
        {
            ...
            name: '<?=$item['name']?>',
            unit: '<?=$item['unit']?>',
            unit_in_details: '<?=$item['unit_in_details']?>',
...
<div id="content-wrapper">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-upload"></i> Thêm phiếu xuất <?=$is_fruit?'trái cây':'kho'?></h2>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <form id="frmExportInventory" role="form" method="post" action="<?=BASE_URL?>xu-ly">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-export">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control float" id="item_quantity_in_details" name="item_quantity_in_details[]" placeholder="SL chi tiết"/></td>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="action" value="admin_export_inventory"/>
