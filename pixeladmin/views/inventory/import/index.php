    <div id="content-wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-download fa-fw"></i> Phiếu nhập <?=$is_fruit?'trái cây':'kho'?></h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="list_container" class="table-responsive">
                        <?php $controlerObj->load_view("inventory/import/list");?>
                    </div>
                    <div class="for_datatable_filter">
                        <ul>
                            ...
                            <li>
                                <a href="<?=BASE_URL. ($is_fruit?$URIs['inventory_import_fruits']:$URIs['inventory_import'])?>/them" class="btn btn-success"><i class="fa fa-plus"></i> Thêm phiếu nhập</a>
                            </li>
                        </ul>
