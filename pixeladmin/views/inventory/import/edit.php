...
<div id="content-wrapper">
	<div id="page-wrapper">
		<?php if (!$id || !$details):?>
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header"><i class="fa fa-warning"></i> ID phiếu nhập kho không chính xác!!</h2>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
		<?php else:
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header"><i class="fa fa-download"></i> Phiếu nhập kho - Mã <?=getvalue($first_record, 'id')?></h2>
						...
						<table class="table table-striped table-bordered table-hover" id="dataTables-import">
							...
							<?php foreach($details as $item):?>
								<tr>
									...
									<td><div class="item_info"><?=getvalue($item, 'name'). (!empty($item['category_name'])?' - '.$item['category_name']:''). ' - '. getvalue($item, 'unit')?></div></td>
