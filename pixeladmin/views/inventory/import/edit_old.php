                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <form id="frmImportInventory" role="form" method="post" action="<?=BASE_URL?>xu-ly">
                      ...
                      <div class="form-group col-lg-4 col-md-4 padding-left">
                        ...
                        <input class="form-control" id="import_date" name="import_date" type="text" data-date-format="dd/mm/yyyy" data-date-startdate="<?=date('d/m/Y', strtotime('-1 year'))?>" data-date-enddate="<?=date('d/m/Y')?>" value="<?=date('d/m/Y', strtotime($first_record['import_date']))?>" readonly=""/>
                      </div>
                      <div class="clear"></div>
                      <div class="form-group col-lg-4 col-md-4">
                        <label for="warehouse_id" class="control-label">Kho *</label>
                        <?php echo html_select($warehouses, 'id', 'name', 'name="warehouse_id" disabled="" required="" class="form-control" id="warehouse_id"', null, getvalue($first_record, 'warehouse_id'));?>
                      ...
                      <table class="table table-striped table-bordered table-hover" id="dataTables-import">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" disabled="" class="form-control item_name" id="item_name" name="item_name[]" placeholder="Tên hàng" value="<?=getvalue($item, 'name')?>"/></td>
                                ...
                                <td><input type="text" disabled="" class="form-control" id="item_unit" name="item_unit[]" placeholder="Đơn vị" value="<?=getvalue($item, 'unit')?>"/></td>
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="action" value="admin_edit_import_inventory"/>
                      </div>
                    </form>
                </div>
                <!-- /.col-lg-12 -->
