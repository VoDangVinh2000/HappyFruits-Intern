<div id="content-wrapper">
    <div id="page-wrapper">
        <?php if (!$id || !$details):?>
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-warning"></i> ID phiếu kiểm kê trái cây không chính xác!!</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        <?php else: ?>
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-download"></i> Phiếu kiểm kê trái cây - Mã <?=getvalue($export_record, 'id')?></h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <form id="frmCheckInventory" role="form" method="post" class="one-line" action="<?=BASE_URL?>xu-ly">
                        ...
                        <div class="form-group col-lg-4 col-md-4">
                            ...
                            <?php echo html_select($warehouses, 'id', 'name', 'disabled="" required="" class="form-control" id="warehouse_id"', null, getvalue($export_record, 'warehouse_id'));?>
                            <input type="hidden" value="<?=getvalue($export_record, 'warehouse_id')?>" name="warehouse_id"/>
                        ...
                        <table class="table table-bordered table-hover" id="dataTables-check">
                            ...
                            ?>
                                <tr class="warehouse_<?=$item['warehouse_id']?>" <?=$item['warehouse_id']!=getvalue($export_record, 'warehouse_id')?'style="display: none;"':''?>>
                                    <td>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="action" value="admin_edit_check_inventory_fruits"/>
                        </div>
                    </form>
                </div>
                <!-- /.col-lg-12 -->
