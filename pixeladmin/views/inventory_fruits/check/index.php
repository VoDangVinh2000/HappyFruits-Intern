    <div id="content-wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><i class="fa fa-upload fa-fw"></i> Phiếu kiểm kê trái cây</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="list_container" class="table-responsive">
                        <?php $controlerObj->load_view("inventory_fruits/check/list");?>
                    </div>
                    <div class="for_datatable_filter">
                        <ul>
                            ...
                            <li>
                                <a href="<?=BASE_URL. $URIs['inventory_check_fruits']?>/them" class="btn btn-success"><i class="fa fa-plus"></i> Thêm phiếu kiểm kê</a>
                            </li>
                        </ul>
