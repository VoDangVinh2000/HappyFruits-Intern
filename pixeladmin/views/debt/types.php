            ...
            <div class="row">
                <div class="col-lg-12">
	                    ...
	                    <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-mainlist">
		                    ...
		                    <?php if($types): ?>
			                    <?php foreach($types as $item): ?>
				                    <tr id="<?=$item['id']?>">
					                    <td>
						                    <?php if (Users::can_access('debt', 'type')):?>
						                    <a href="<?=BASE_URL. $URIs['debts']?>/loai/<?=$item['id']?>"><?=$item['id']?></a>
					                        <?php else:?>
						                    <?=$item['id']?>
						                    <?php endif;?>
					                    </td>
					                    ...
					                    <td class="center not_filter">
						                    <?php if (Users::can_access('debt', 'type')):?>
							                    <a target="_blank" href="<?=BASE_URL. $URIs['debts']?>/loai/<?=$item['id']?>" class="btn btn-sm btn-warning" title="Sửa thông tin"><i class="fa fa-edit"></i></a>
	                ...
	                <div class="for_datatable_filter">
		                <ul>
			                <li>
				                <a href="<?=BASE_URL. $URIs['debts'] . '/loai/them'?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm</a>
			                </li>
		                </ul>
