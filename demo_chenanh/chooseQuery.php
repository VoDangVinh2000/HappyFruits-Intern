...
$conn = new database;
$paginatorModelChoose = new paginatorModel;
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-7">
                            <div style="text-align:center" class="paginator">
                                <?php
                                if ($price == 1) {
                                    echo $paginatorModelChoose->paginatorIndex_1($pageCurrent);
                                }
                                if ($price == 2) {
                                    echo $paginatorModelChoose->paginatorIndex_2($pageCurrent);
                                }
                                if ($price == "Full") {
                                    header('location:index.php');
                                }
                                if ($price == 3) {
                                    echo $paginatorModelChoose->paginatorIndex_3($pageCurrent);
                                }
                                if ($price == 4) {
                                    echo $paginatorModelChoose->paginatorIndex_4($pageCurrent);
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="show-product-main">
                        <div class="row">
                            <?php if ($price == 1) {
                                foreach ($paginatorModelChoose->paginator_1($pageCurrent) as $array) { ?>
                                    <div class="col-md-4">
                            ...
                            <?php if ($price == 2) {
                                foreach ($paginatorModelChoose->paginator_2($pageCurrent) as $array) { ?>
                                    <div class="col-md-4">
                                        <input type="hidden" name="idGiayDep" value="<?= $array['ID_GiayDep'] ?>">
                                        <div class="products-distance">
                                            <div class="products-distance-2">
                            ...
                            <?php if ($price == 3) {
                                foreach ($paginatorModelChoose->paginator_3($pageCurrent) as $array) { ?>
                                    <div class="col-md-4">
                                        <input type="hidden" name="idGiayDep" value="<?= $array['ID_GiayDep'] ?>">
                                        <div class="products-distance">
                                            <div class="products-distance-2">
                            ...
                            <?php if ($price == 4) {
                                foreach ($paginatorModelChoose->paginator_4($pageCurrent) as $array) { ?>
                                    <div class="col-md-4">
                                        <input type="hidden" name="idGiayDep" value="<?= $array['ID_GiayDep'] ?>">
                                        <div class="products-distance">
                                            <div class="products-distance-2">
