...
{if($scope.orderedItems[i].quantity){subtotal+=parseInt($scope.orderedItems[i].quantity)*parseInt($scope.orderedItems[i].final_price);total_quantity+=parseInt($scope.orderedItems[i].quantity);var product_id=i.split('|')[1];if(quantityItems[product_id]){quantityItems[product_id]+=parseInt($scope.orderedItems[i].quantity);}else
quantityItems[product_id]=parseInt($scope.orderedItems[i].quantity);var category_id=$scope.orderedItems[i].category_id;if(quantityCategories[category_id])
quantityCategories[category_id]+=parseInt($scope.orderedItems[i].quantity);else
quantityCategories[category_id]=parseInt($scope.orderedItems[i].quantity);}else
...
$scope.has_VAT=true;$scope.payment_method=data.payment_method;$scope.discount_amount=parseFloat($scope.discount_amount).toFixed(3);}
